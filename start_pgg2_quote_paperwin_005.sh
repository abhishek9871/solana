...
cd /root/piggy
RUNID="pgg2_quote_005_$(date -u +%Y%m%d_%H%M%S)"
...
# Same PGG2 signal gates as the winning paper run, scaled to a realistic wallet size.
...
export PGG2_BIRTH_FANOUT_SOL=0.025
...
export PGG2_LIVE_MAX_SESSION_LOSS_SOL=0.050
