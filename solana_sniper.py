...
ALPHA_WALLET_ONLY_MIN_SAMPLES = int(os.environ.get("ALPHA_WALLET_ONLY_MIN_SAMPLES", "100"))
ALPHA_WALLET_ONLY_MIN_WR = float(os.environ.get("ALPHA_WALLET_ONLY_MIN_WR", "0.80"))
ALPHA_WALLET_ONLY_MIN_AVG_EXIT_NET = float(os.environ.get("ALPHA_WALLET_ONLY_MIN_AVG_EXIT_NET", "0.120"))
...
ALPHA_RUNNER_TP1_MID_FRACTION = float(os.environ.get("ALPHA_RUNNER_TP1_MID_FRACTION", "0.50"))
...
COPY_FAST_ALPHA_MIN_ENTRY_MULT = float(os.environ.get("COPY_FAST_ALPHA_MIN_ENTRY_MULT", "1.200"))
...
MARKET_TAPE_ALPHA_MAX_AGE_SEC = float(os.environ.get("MARKET_TAPE_ALPHA_MAX_AGE_SEC", "300.0"))
...
MARKET_TAPE_ALPHA_STRONG_SIZE_MIN_SAMPLES = int(os.environ.get("MARKET_TAPE_ALPHA_STRONG_SIZE_MIN_SAMPLES", "15"))
MARKET_TAPE_ALPHA_STRONG_SIZE_MIN_WR = float(os.environ.get("MARKET_TAPE_ALPHA_STRONG_SIZE_MIN_WR", "0.70"))
...
MARKET_TAPE_REVIVAL_MAX_AGE_SEC = float(os.environ.get("MARKET_TAPE_REVIVAL_MAX_AGE_SEC", "300.0"))
...
COPY_FAST_IGNITION_MIN_MULT = float(os.environ.get("COPY_FAST_IGNITION_MIN_MULT", "1.120"))
COPY_FAST_IGNITION_STRONG_MULT = float(os.environ.get("COPY_FAST_IGNITION_STRONG_MULT", "1.350"))
COPY_FAST_IGNITION_MIN_SWARM = int(os.environ.get("COPY_FAST_IGNITION_MIN_SWARM", "4"))
COPY_FAST_IGNITION_FAST_MULT = float(os.environ.get("COPY_FAST_IGNITION_FAST_MULT", "1.300"))
