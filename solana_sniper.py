...
MARKET_TAPE_SCOUT_MIN_BC_MOVE = float(os.environ.get("MARKET_TAPE_SCOUT_MIN_BC_MOVE", "1.005"))
...
MARKET_TAPE_SCOUT_CONFIRM_MIN_MULT = float(os.environ.get("MARKET_TAPE_SCOUT_CONFIRM_MIN_MULT", "1.000"))
