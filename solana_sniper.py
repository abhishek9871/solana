...
MARKET_TAPE_HIGH_MOVE_MIN_BUY_SOL = float(os.environ.get("MARKET_TAPE_HIGH_MOVE_MIN_BUY_SOL", "8.0"))
...
MARKET_TAPE_SCOUT_MIN_TRACKED = int(os.environ.get("MARKET_TAPE_SCOUT_MIN_TRACKED", "3"))
MARKET_TAPE_SCOUT_MIN_BUY_SOL = float(os.environ.get("MARKET_TAPE_SCOUT_MIN_BUY_SOL", "2.4"))
