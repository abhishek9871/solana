...
cd /root/piggy
RUNID="pgg2_quote_$(date -u +%Y%m%d_%H%M%S)"
...
# Quote mode can use either the keypair file or only PGG2_LIVE_PUBKEY.
...
export PIGGY_MAX_PENDING_STRIKES=2
export PIGGY_SCOUT_SOL=0.005
export PIGGY_MAX_POSITION_SOL=0.005
...
export PGG2_SECOND_WAVE_MAX_SCOUT_SOL=0.005
export PGG2_CURVE_LAG_REVEAL_ENABLED=1
export PGG2_CURVE_LAG_SOL=0.005
...
export PGG2_LIVE_MIN_WALLET_RESERVE_SOL=0.040
export PGG2_LIVE_MAX_SESSION_LOSS_SOL=0.020
