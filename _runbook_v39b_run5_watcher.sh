#!/bin/bash
# RUN5 watcher — adds PRESEND-LANDED-GATE + presend_landed_pnl_below_floor visibility
cd /root/piggy
RUNID=$(cat current_pgg2_live_mirror_runid.txt)
LOG=/root/piggy/logs/${RUNID}.log
echo "WATCHER_RUN5_ARMED runid=$RUNID"

end_count=0

tail -n 0 -F "$LOG" | grep -E --line-buffered 'PGG2-LIVE-MIRROR-START|PGG2-V39-ENTRY-ROUTER|PGG2-V39-LIVE-PRESEND-REQUOTE|PGG2-V39-LIVE-PRESEND-LANDED-GATE|presend_landed_pnl_below_floor|PGG2-V39-LIVE-BUY|PGG2-V39-LIVE-SELL|PGG2-V39-LIVE-TOKEN-RECONCILE|PGG2-V39-LIVE-TOKEN-DRIFT|PGG2-V39-LIVE-POSTBUY-REPRICE|PGG2-V39-LIVE-POSTBUY-GATE|PGG2-V39-LIVE-WALLET-DELTA|PGG2-V39-LIVE-PNL-RECONCILE|PGG2-V39-LIVE-MIRROR-END|PGG2-V39-STOP|PGG2-POSITION-TOKEN-MISMATCH-FATAL|PGG2-RISK-CLOSE-FAIL|PGG2-LIVE-SELL-FAIL|Traceback|sim_needed=1|route_not_pump_bc' | while IFS= read -r line; do
  echo "$line"
